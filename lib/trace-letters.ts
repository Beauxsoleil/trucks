const LETTER_PATHS = [
  ...
  { name: "A", paths: ["M210 70L100 315", "M210 70L320 315", "M145 220H275"], speech: "A. Ah, ah, ah. A as in apple." },
  ...
  { name: "G", paths: ["M300 110C245 30 110 60 110 195C110 325 260 350 305 265V210", "M225 210H305"], speech: "G. Guh, guh, guh. G as in goat." },
  { name: "J", paths: ["M265 75V255C265 340 120 350 120 260", "M125 75H300"], speech: "J. Juh, juh, juh. J as in jump." },
  { name: "K", paths: ["M135 75V315", "M300 75L135 195", "M135 195L305 315"], speech: "K. Kuh, kuh, kuh. K as in kite." },
  { name: "M", paths: ["M105 75V315", "M105 75L210 225L315 75V315"], speech: "M. Mmm, mmm, mmm. M as in moon." },
  { name: "N", paths: ["M120 75V315", "M120 75L300 315", "M300 75V315"], speech: "N. Nnn, nnn, nnn. N as in nest." },
  ...
  { name: "Y", paths: ["M110 75L210 195", "M310 75L210 195V315"], speech: "Y. Yuh, yuh, yuh. Y as in yellow." },
